...
class WeatherTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "MyCustomCell", for: indexPath) as! WeatherTableViewCell
                ...
                cell.weatherImage.image = UIImage(named: forecasts[indexPath.row])
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let destVC = segue.destination as! detailViewController
                ...
                destVC.city = cities[selectRow!]
                destVC.temp = temps[selectRow!]
                destVC.forecast = forecasts[selectRow!]
                destVC.image = UIImage(named: forecasts[selectRow!])
